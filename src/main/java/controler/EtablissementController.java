...
public class EtablissementController {
    ...
    if(etb.authentify(etablissement)) {
    	...
    	etablissement = etb.getEtabByEmail(etablissement.getEmail());
    ...
    @RequestMapping(value="/modiferCompteEtab/{email}")
    public String edit(@PathVariable String email, Model m) throws SQLException{
    	
    	Etablissement etablissement = etb.getEtabByEmail(email);
