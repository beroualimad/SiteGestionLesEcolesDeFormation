...
.table2 th,table td{
	padding: 7px 25px;
	width:80px;
	border-bottom: 1px solid #adb5bd52;
}
</style>
			...
			<form:form method="POST" action="/dmnd" modelAttribute="emploi">
				...
				<div class="modal-body">					
					<div class="form-group">
						<label> Id</label>
						<form:input path="id_offer" type="text" class="form-control" required="required" autocomplete="off" />
					</div>
					<div class="form-group">
						<label>E-mail Formateur</label>
						<form:input path="Email_etab" type="text" class="form-control" required="required" autocomplete="off" />
					</div>
					<div class="form-group">
						<label>E-mail Etablisement</label>
						<form:input path="Email_frm" class="form-control" required="required" autocomplete="off" />
					</div>
