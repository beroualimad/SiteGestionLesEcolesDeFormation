			...
			<form:form method="POST" action="/addemp" modelAttribute="emploi">
				...
				<div class="modal-body">					
					<div class="form-group">
						<label>Id</label>
						<form:input path="id_offer" type="text" class="form-control" name="id" required="required" autocomplete="off" />
					</div>
					<div class="form-group">
						<label>E_mail d'etablisement</label>
						<form:input path="Email_etab" type="text" class="form-control" name="E_mail_d'etablisement" required="required" autocomplete="off"  />
					</div>
					<div class="form-group">
						<label>Type d'omploi</label>
						<form:input path="Type_emp" type="text" class="form-control" name="Type_d'omploi" required="required" autocomplete="off" />
					</div>
					<div class="form-group">
						<label>Description</label>
						<form:textarea path="Description" class="form-control" name="Description" required="required" autocomplete="off" ></form:textarea>
					</div>
					<div class="form-group">
						<label>Date Debut</label>
						<form:input path="Date_deb" type="date" class="form-control" name="Date_Debut" required="required" autocomplete="off" />
					</div>
					
					<div class="form-group">
						<label>Date Fin</label>
						<form:input path="Date_fin" type="date" class="form-control" name="Date Fin" required="required" autocomplete="off" />
					</div>

					<div class="form-group">
						<label>Prix</label>
						<form:input path="Salary" type="text" class="form-control" name="Prix" required="required" autocomplete="off" />
					</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form:form method="POST" action="/delemp" modelAttribute="emploi">
				...
				<div class="form-group">
						<label>Id</label>
						<form:input path="id_offer" type="text" class="form-control" required="required"  name="id" autocomplete="off" />
					</div>
				</div>
				<div class="modal-footer">
