	...
	<div class="center">
        ...
        <form:form method="POST" action="/AddEtabInDB" modelAttribute="etablissement">
            ...
            <div class="txt-fieled">
				<form:input required="required" autocomplete="off"  type="text" path="nom"/>
				<span></span>
            ...
            <div class="txt-fieled">
				<form:input required="required" autocomplete="off"  type="email" path="email"/>
				<span></span>
                <form:label path="email">email</form:label>
            </div>
            
            <div class="txt-fieled">
				<form:input required="required" autocomplete="off"  type="password" path="pass"/>
				<span></span>
                <form:label path="pass">password</form:label>
            </div>
            
            <div class="txt-fieled">
				<form:input required="required" autocomplete="off"  type="adress" path="adress"/>
				<span></span>
                <form:label path="adress">adress</form:label>
            </div>
            
            <div class="txt-fieled">
				<form:input required="required" autocomplete="off"  type="text" path="desc"/>
				<span></span>
