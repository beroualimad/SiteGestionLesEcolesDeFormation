	...
	<div class="center">
        ...
        <form:form method="POST" action="/AddOffrebInDB" modelAttribute="offre">
            ...
            <div class="txt-fieled">
				<form:input required="required" autocomplete="off"  type="text" path="idEtab"/>
				<span></span>
            ...
            <div class="txt-fieled">
				<form:input required="required" autocomplete="off"  type="date" path="date_deb"/>
				<span></span>
                <form:label path="date_deb"></form:label>
            </div>
            
            <div class="txt-fieled">
				<form:input required="required" autocomplete="off"  type="date" path="date_fin"/>
				<span></span>
