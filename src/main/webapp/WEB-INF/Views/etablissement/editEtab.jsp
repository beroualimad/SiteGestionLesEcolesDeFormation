...
<body>
	<div class="center">
		...
		action="${pageContext.request.contextPath}/editsaveEtab">
            ...
            <div class="txt-fieled">
				<form:input required="required" autocomplete="off"  type="text" path="email"/>
				<span></span>
                <form:label path="email">nom de ecole</form:label>
            </div>
            
            <div class="txt-fieled">
				<form:input required="required" autocomplete="off"  type="text" path="pass"/>
				<span></span>
            ...
            <div class="txt-fieled">
				<form:input required="required" autocomplete="off"  type="text" path="adress"/>
				<span></span>
