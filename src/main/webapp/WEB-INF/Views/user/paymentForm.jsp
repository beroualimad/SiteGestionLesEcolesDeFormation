	 ...
	 <div class="container">
        <div class="form">
            ...
            <div class="filed">
                ...
                <input type="text" name="Nom" id="nom" required="required" autocomplete="off" >
            ...
            <div class="filed pass">
                <div>
                    ...
                    <input type="password" name="Nom" id="nom"  required="required" autocomplete="off" >
                </div>
            ...
            <div class="filed">
                <div>
                    ...
                    <input type="date" name="date" id="date"  required="required" autocomplete="off">
                </div>
