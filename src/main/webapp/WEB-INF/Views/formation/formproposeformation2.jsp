...
<body>
    ...
    <form:form id="form1" method="POST" action="/addform" modelAttribute="formation">
        ...
        <form:input placeholder="Nom de formation"  path="name" type="text" name="name_form" id="name_form" required="required" autocomplete="off" />  
		</div>
		...
		<div class="filed">
          ...
          <form:input placeholder="Email de formateur " path="E_mail" type="email" id="email" name="email" required="required" autocomplete="off" />
		</div>
 			
 			<div class="filed">
            
          <form:input placeholder="Email de Etablisement " path="email" type="email" id="email" name="email" required="required" autocomplete="off" />
			</div>
			<div class="filed">
         <label for="description" class="details"></label>
         <form:textarea  placeholder="Description de formation" path="description" id="description" rows="15" required="required" autocomplete="off"></form:textarea>
		</div>
      	<div class="filed">
